...
CREATE TABLE "transactions" (
    ...
    "cretidedAccountId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_cretidedAccountId_fkey" FOREIGN KEY ("cretidedAccountId") REFERENCES "accounts"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
